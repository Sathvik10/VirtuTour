...
const AcademicPlaza = {
    name: "AcademicPlaza",
    latitude: 30.615467693414473, 
    longitude: -96.34135938960932, 
    image: require('../images/AcadPlaza.jpg'),
    track : Asset.fromModule(require('../../constants/audio/AcademicPlaza.mp3')),
    description: "This is The centerpiece for main campus and gathering spot for students studying and relaxing. The plaza continues to serve as a venue for a number of traditions. The Academic Plaza is home to a statue of Lawrence Sullivan Ross, or Sully, as students call him. Sully was a former Texas Ranger, Governor of Texas and President of Texas A&M. During his presidency, way back in the 1890s, the Aggie Ring was designed, the Fightin' Texas Aggie Band was formed, and intercollegiate football was brought to campus. Silver Taps, one of Texas A&M's most honored traditions that pays tribute to a passing current student, also takes place here. A rendition of Taps, known as Silver Taps, is played from the dome of the Academic Building at the end of the ceremony. The plaza is surrounded by significant architectural features, including the large oak tree known as the Century Tree, which has become a symbol of lasting love and commitment among Aggie couples. The Academic Building, with its ionic columns and classical pediment, adds to the aesthetic and historical richness of the plaza. In recent years, there has been a focus on enhancing the Academic Plaza's role as a central gathering place. In 2021, Texas A&M's Board of Regents announced plans to invest about $1 million to reimagine the plaza, adding more green spaces and historical context to enrich its significance."
}
...
const AcademicBuild = {
    ...
    image: require('../images/AcademicBuilding.jpg'),
    track : Asset.fromModule(require('../../constants/audio/xyz.mp3')),
...
const StudentRecCentre = {
    ...
    image: require('../images/StudentRec.jpg'),
...
const CushingLibrary = {
    ...
    image: require('../images/CushingLibrary.jpg'),
...
const SullivanRoss = {
    ...
    image: require('../images/SulRoss.jpg'),
...
const ReedArena = {
    ...
    image: require('../images/ReedArena.jpg'),
...
const BonfireMemorial = {
    name: "BonfireMemorial",
    latitude: 30.62297526609954, 
    longitude: -96.33453045114656,
    image: require('../images/Bonfire.jpg'),
    track : Asset.fromModule(require('../../constants/audio/Bonfire.mp3')),
    description: "The Bonfire Memorial at Texas A&M University is a poignant tribute to the 12 students who tragically lost their lives during the collapse of the Aggie Bonfire on November 18, 1999. This memorial not only commemorates those who died but also serves as a symbol of the Aggie Spirit and the deep sense of community at Texas A&M. The design of the Bonfire Memorial is thoughtful and symbolic, incorporating several elements that reflect the tradition, history, and spirit of the Aggie Bonfire. Visitors enter the memorial through the Tradition Plaza, which marks the entrance and reflects on the activities that bring the Aggie community together. This area features a granite Spirit Wall engraved with lines from The Spirit of Aggieland, and panels engraved with The Last Corps Trip, a poem traditionally recited before the lighting of the Bonfire. The Bonfire Memorial is not just a physical structure but a profound representation of the Aggie community's resilience and unity. It stands as a reminder of the tragic event that deeply affected Texas A&M and led to the reevaluation of the Bonfire tradition. The memorial also serves as a place for reflection and remembrance, offering a space where the Aggie family can come together to honor those who lost their lives."
}
...
const CorpOfCadets = {
    ...
    image: require('../images/CorpOfCadets.jpg'),
...
const CenturySquare = {
    ...
    image: require('../images/CenturySquare.jpg'),
...
const CommonsDining = {
    ...
    image: require('../images/Commons.jpg'),
...
const AggieSpirit = {
    ...
    image: require('../images/aggieSpirit.jpg'),
...
const RingStatue = {
    ...
    image: require('../images/RingStatue.jpg'),
...
const BrightBuilding = {
    ...
    image: require('../images/sterlingCEvansLibrary.jpg'),
    track : Asset.fromModule(require('../../constants/audio/BrightBuilding.mp3')),
    description: "As we explore the Bright Building here at Texas A&M University, you're stepping into a world where technology and education converge. This facility, named in honor of the Bright family, a prominent supporter of the university, is a key part of the College of Engineering. It's renowned for housing advanced research laboratories and innovative learning spaces. The Bright Building is a hub for cutting-edge research in fields like aerospace, mechanical, and industrial engineering. Here, students and faculty work together on groundbreaking projects, from robotics to energy systems. The building’s design facilitates collaboration and creativity, featuring open labs, collaborative workspaces, and state-of-the-art equipment. As we walk through, you'll notice the dynamic atmosphere where theory and practice blend seamlessly, fostering an environment where future engineers are trained to solve real-world challenges. Beyond academics, the Bright Building symbolizes Texas A&M's commitment to providing top-tier facilities for its community, nurturing the next generation of engineers and innovators."
}
...
const RudderComplex = {
    ...
    image: require('../images/sterlingCEvansLibrary.jpg'),
    track : Asset.fromModule(require('../../constants/audio/RudderComplex.mp3')),
    description: "Here in the Rudder Complex at Texas A&M University, we find ourselves at the cultural and theatrical heart of the campus. This complex, named in honor of General James Earl Rudder, a revered president of the university and a World War II hero, serves as a focal point for student activities and events. As you look around, you'll see the Rudder Theatre, a premier venue for a variety of performances, from plays and concerts to guest speakers and cultural events. The complex also includes Rudder Auditorium, a larger space that hosts major performances and ceremonies, drawing audiences from across the university and the broader community. Adjacent to the theater and auditorium, Rudder Tower stands tall, housing important administrative offices, including the Office of the President. This tower is a prominent feature of the university skyline and offers panoramic views of the campus. The Rudder Complex isn't just a location for entertainment and administration; it's a hub of student life. Surrounding the complex, you'll find bustling areas filled with students studying, socializing, and participating in various student organizations. It's a place where the Aggie spirit is palpable, embodying the university's commitment to leadership, service, and community engagement. As we walk through this area, you can feel the dynamic energy that makes Texas A&M such a unique and vibrant institution."
}
...
const ZachryBuilding = {
    ...
    image: require('../images/sterlingCEvansLibrary.jpg'),
    track : Asset.fromModule(require('../../constants/audio/ZachryBuilding.mp3')),
    description: "Here inside the Zachry Engineering Education Complex at Texas A&M University, we're surrounded by an environment that's at the forefront of engineering education. Named for H.B. Zachry, an esteemed alumnus and benefactor, this complex represents a revolutionary approach to engineering learning and collaboration. The Zachry building is not your typical educational facility. It's designed to be a living laboratory, where students don't just learn about engineering; they experience it. You'll notice the open, flexible learning spaces, equipped with the latest technology, fostering an environment of innovation and interactive learning. Particularly impressive is the Engineering Design Center, where students tackle real-world problems, working in teams to develop practical solutions. This hands-on approach prepares students for the challenges of modern engineering careers, emphasizing teamwork, problem-solving, and creativity. Sustainability is another key feature here. The building itself is a lesson in sustainable design, featuring energy-efficient systems and environmentally conscious construction. It’s a physical embodiment of the university’s commitment to the future. As we move through the Zachry Building, you can feel the energy of discovery and progress. It's a place where the next generation of engineers are being shaped, in an environment that mirrors the dynamic, ever-evolving field of engineering. The Zachry Engineering Education Complex stands as a testament to Texas A&M's commitment to excellence in engineering education and its dedication to preparing students for a successful future."
}
...
const HaynesEngineeringBuilding = {
    ...
    image: require('../images/sterlingCEvansLibrary.jpg'),
    track : Asset.fromModule(require('../../constants/audio/HaynesEngineeringBuilding.mp3')),
    description: "The Haynes Engineering Building at Texas A&M University is a hub of innovation and cutting-edge research within the College of Engineering. This building, dedicated to fostering advanced engineering studies, is named in recognition of the generous contributions from James J. and Miriam B. Haynes. The Haynes Engineering Building is designed to support a wide range of engineering disciplines, with state-of-the-art laboratories and research facilities. These spaces are equipped with advanced tools and technologies, enabling students and faculty to engage in groundbreaking research and development projects. A distinctive feature of this building is its emphasis on collaborative spaces. You'll notice areas designed to encourage interaction and teamwork among students, faculty, and industry partners. This environment is conducive to cross-disciplinary projects and innovation, reflecting the dynamic nature of modern engineering. The building also serves as a learning environment, with classrooms and lecture halls equipped with the latest teaching technologies. These spaces are designed to enhance the educational experience, integrating theoretical knowledge with practical application. As you walk through the Haynes Engineering Building, you can feel the passion for discovery and the commitment to excellence that defines Texas A&M's engineering program. This building is not just a structure; it's a testament to the university's dedication to shaping the engineers of tomorrow, who will tackle the challenges and opportunities of an ever-changing world."
}
